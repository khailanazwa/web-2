...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <center><span class="brand-text font-weight-light">Manajemen Dosen</span></center>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <div class="image">
                <img src="dist/img/awa.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="#" class="d-block">KHAILA NAZWA</a>
            </div>
            </div>
